...
function help() {
  ...
  echo "* guide-version : to build the guide only, in the versioned namespace /v/0.7.0-DIFFUSION-R55-SNAPSHOT/"
...
function parse_mode() {
  ...
  guide-version)
    ...
    DIRS_TO_MOVE[0]=guide
    # BROOKLYN_VERSION_BELOW
    DIRS_TO_MOVE_TARGET[0]=v/0.7.0-DIFFUSION-R55-SNAPSHOT
    DIRS_TO_MOVE[1]=style
    STYLE_SUBDIR=${DIRS_TO_MOVE_TARGET[0]}/style
    DIRS_TO_MOVE_TARGET[1]=$STYLE_SUBDIR
    INSTALL_RSYNC_OPTIONS=""
